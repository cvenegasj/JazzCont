<%-- 
    Document   : ver-comprobantes-cliente
    Created on : 28/12/2012, 11:11:52 PM
    Author     : Venegas
--%>
    ...
    <head>
        ...
        <script type="text/javascript"> 
            $(function() {
                ...
                $("#selectComprobantesCompras").change(function() {
                    var selectedOption = $("#selectComprobantesCompras option:selected").val();
                    
                    if(selectedOption == "Seleccione mes") {
                        return;
                    }

                    var urlDestino = "ContenedorComprobantesCompraAction_show?ruc=<s:property value="ruc" />&periodo=" + selectedOption;
                    window.location = urlDestino;
                });
                
                $("#selectComprobantesVentas").change(function() {
                    var selectedOption = $("#selectComprobantesVentas option:selected").val();
                    
                    if(selectedOption == "Seleccione mes") {
                        return;
                    }

                    var urlDestino = "ContenedorComprobantesVentaAction_show?ruc=<s:property value="ruc" />&periodo=" + selectedOption;
                    window.location = urlDestino;
                });
            ...
            <div id="widthArea">
                ...
                <div id="contentArea">
                    ...
                    <div id="headerContentArea">
                        <h1 class="medium">Registro de Comprobantes: Nuevo Régimen Simplificado</h1>
                    </div>                    

                    <div id="libros_wrapper">
                        <div class="libro_wrapper">
                            <a href="#">Comprobantes de Compras</a>
                            <div class="libroMeses">
                                <select id="selectComprobantesCompras">
                        ...
                        <div class="libro_wrapper">
                            <a href="#">Comprobantes de Ventas</a>
                            <div class="libroMeses">
                                <select id="selectComprobantesVentas">
                                    <option>Seleccione mes</option>                                   
                                    <option>06/2012</option>
                                    <option>07/2012</option>
                                    <option>08/2012</option>
