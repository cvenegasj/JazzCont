<%-- 
    Document   : ver-totales-por-cliente
    Created on : 06/03/2013, 08:53:43 PM
    Author     : Venegas
--%>
            ...
            <div id="widthArea">
                ...
                <div id="contentArea">
                    ...
                    <div id="headerContentArea">
                        <h1 class="medium">Totales de compras y ventas: <strong><s:property value="periodo" /></strong></h1>
                    </div>                    

                    <div id="divR_wrapper">
                        <div class="detalleResumen1">
                            <div class="lfloat">
                                <span>Número de ventas del mes:</span>
                            </div>
                            <div class="lfloat">
                                <span>69</span>
                            </div>
                        ...
                        <div class="detalleResumen1">
                            <div class="lfloat">
                                <span>Monto promedio de venta:</span>
                            </div>
                            <div class="lfloat">
                                <span>S/. 15.00</span>
                            </div>
                        ...
                        <div class="detalleResumen1">
                            <div class="lfloat">
                                <span>Ingreso neto del mes:</span>
                            </div>
                            <div class="lfloat">
                                <span>S/. 700.00</span>
                            </div>
