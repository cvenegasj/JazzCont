<%-- 
    Document   : ver-contenedor-comprobantes-venta
    Created on : 29/12/2012, 03:55:52 PM
    Author     : Venegas
--%>
            ...
            <div id="widthArea">
                ...
                <div id="contentArea">
                    ...
                    <div id="headerContentArea">
                        <h1 class="medium">Contenedor de Comprobantes de Venta: <strong><s:property value="periodo" /></strong></h1>
                        <div class="right">
                    ...
                    <div>
                        <table id="contenedorVentasTable" class="contenedorComprobantesTable">
                            <thead>
                                <tr>
