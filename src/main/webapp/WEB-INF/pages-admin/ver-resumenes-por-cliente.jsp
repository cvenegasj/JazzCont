    ...
    <head>
        ...
        <script type="text/javascript"> 
            $(function() {
                ...
                $("#selectTotales").change(function() {
                    var selectedOption = $("#selectTotales option:selected").val();
                    
                    if(selectedOption == "Seleccione mes") {
                        return;
                    }

                    var urlDestino = "ResumenesAction_showTotales?ruc=<%= request.getParameter("ruc")%>&periodo=" + selectedOption;
                    window.location = urlDestino;
                });
                
                $("#selectTributos").change(function() {
                    var selectedOption = $("#selectTributos option:selected").val();
                    
                    if(selectedOption == "Seleccione mes") {
                        return;
                    }

                    var urlDestino = "ResumenesAction_showTributos?ruc=<%= request.getParameter("ruc")%>&periodo=" + selectedOption;
                    window.location = urlDestino;
                });
        ...
        <div id="fixed_main"> 
            ...
            <div id="widthArea">
                ...
                <div id="contentArea">
                    ...
                    <div id="divR_wrapper">
                        <div class="divR">
                            <a id="resumen1" href="#">Totales de Compras y Ventas</a>
                            <div class="resumenMeses">
                                <select id="selectTotales">
                        ...
                        <div class="divR">
                            <a id="resumen2" href="#">Tributo mensual</a>
                            <div class="resumenMeses">
                                <select id="selectTributos">
                                    <option>Seleccione mes</option>                                   
                                    <option>06/2012</option>
                                    <option>07/2012</option>
                                    <option>08/2012</option>
