<%-- 
    Document   : ver-tributos-por-cliente
    Created on : 06/03/2013, 08:54:03 PM
    Author     : Venegas
--%>
            ...
            <div id="widthArea">
                ...
                <div id="contentArea">
                    ...
                    <div id="headerContentArea">
                        <h1 class="medium">Cálculo de monto a tributar: <strong><s:property value="periodo" /></strong></h1>
                    </div>                    

                    <div id="divR_wrapper">
                        <div class="detalleResumen1">
                            <div class="lfloat">
                                <span>Tributo mensual:</span>
                            </div>
                            <div class="lfloat">
                                <span>0.015 * </span><span class="pointer color1" title="Ingreso neto mensual">700.00</span><span> + 0.18 * </span><span class="pointer color1" title="Ingreso bruto mensual">1725.00</span><br />
                                <span>S/. 321.00</span>
                            </div>
