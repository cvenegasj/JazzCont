            ...
            $(function() {
                ...
                $("#btnOk").on("click", function(e) {
                    ...
                    var nuevaLinea = "<tr class=\"linea\">\n\
                                     <td>" + '<s:textfield name="detalleLRC.comprobanteCompra.detallesComprobanteCompra[' + indexDetalle + '].cantidad" value="'+ cantidad + '" readonly="true" />' + "</td>\n\
                                     <td>" + '<s:textfield name="detalleLRC.comprobanteCompra.detallesComprobanteCompra[' + indexDetalle + '].productoCompras.nombre" value="'+ descripcion + '" readonly="true" />' + "</td>\n\
                                     <td>" + '<s:textfield name="detalleLRC.comprobanteCompra.detallesComprobanteCompra[' + indexDetalle + '].precioUnitario" value="'+ pUnitarioF + '" readonly="true" />' + "</td>\n\
                                     <td>" + '<s:textfield name="detalleLRC.comprobanteCompra.detallesComprobanteCompra[' + indexDetalle + '].subtotal" value="'+ importeF + '" readonly="true" />' + "</td>\n\
                                     <td></td>\n\
                                     </tr>";
                                ...
                                <table id="inputDetallesCompra" class="detallesComprobanteTable">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th><s:textfield id="base" name="detalleLRC.comprobanteCompra.base" value="0.00" readonly="true" /></th>
                                            <th></th>                                             
                                        </tr>
                                        <tr> 
                                            <th colspan="3" class="right">IGV</th>
                                            <th><s:textfield id="igv" name="detalleLRC.comprobanteCompra.igv" value="0.00" readonly="true" /></th>
                                            <th></th> 
                                        </tr>
                                        <tr>                                                                                      
                                            <th colspan="3" class="right">Total</th>
                                            <th><s:textfield id="total" name="detalleLRC.comprobanteCompra.importeTotal" value="0.00" readonly="true" /></th>
                                            <th></th>
                                        </tr>
                                    </tfoot>
                                </table>
