<%-- 
    Document   : registrar-comprobante-compra
    Created on : 28/12/2012, 03:44:53 PM
    Author     : Venegas
--%>
        ...
        <script type="text/javascript"> 
            $(function() {
                ...
                $(".btnOk").on("click", function(e) {
                    ...
                    $("#base").text($.number(base, 2));
                    $("#igv").text($.number(igv, 2));                    
            ...
            <div id="widthArea">
                ...
                <div id="contentArea">
                    ...
                    <div id="headerContentArea">
                        <h1 class="medium">Registrar nuevo comprobante de compra</h1>
                    </div>                    
                    ...
                    <div id="form_wrapper">                        
                        ...
                        <s:form action="" method="post" cssClass="inputForm">
                            ...
                            <fieldset id="rCompraForm_comprobantePago">
                                ...
                                <dl>
                                    <dt>Fecha de emisión del comprobante de pago</dt>
