<%-- 
    Document   : registrar-asiento-libro-cerrado
    Created on : 09/05/2013, 07:00:46 PM
    Author     : Venegas
--%>
        ...
        <div id="fixed_main"> 
            ...
            <div id="widthArea">
                ...
                <div id="contentArea">  
                    ...
                    <div id="divR_wrapper">
                        <img src="<s:url value="/img/iconic/x_alt_24x24.png" />" /><span>  No se puede realizar el registro porque el libro está cerrado!</span>
                    </div>
